...
import type { AgentPartInput, AppAgentsResponses, AppLogErrors, AppLogResponses, AppSkillsResponses, Auth as Auth3, AuthRemoveErrors, AuthRemoveResponses, AuthSetErrors, AuthSetResponses, CommandListResponses, Config as Config3, ConfigGetResponses, ConfigProvidersResponses, ConfigUpdateErrors, ConfigUpdateResponses, EventSubscribeResponses, EventTuiCommandExecute, EventTuiPromptAppend, EventTuiSessionSelect, EventTuiToastShow, ExperimentalFlowOverlayTransformResponses, ExperimentalLyriaMusicErrors, ExperimentalLyriaMusicResponses, ExperimentalResourceListResponses, ExperimentalRuntimeEnvErrors, ExperimentalRuntimeEnvResponses, ExperimentalSessionListResponses, ExperimentalStorageAssetErrors, ExperimentalStorageAssetResponses, ExperimentalStorageManifestResponses, ExperimentalStorageUploadErrors, ExperimentalStorageUploadMultipartErrors, ExperimentalStorageUploadMultipartResponses, ExperimentalStorageUploadResponses, ExperimentalTogetherTranscriptionErrors, ExperimentalTogetherTranscriptionResponses, ExperimentalVoiceResponses, FileListResponses, FilePartInput, FilePartSource, FileReadResponses, FileStatusResponses, FindFilesResponses, FindSymbolsResponses, FindTextResponses, FormatterStatusResponses, GlobalBillingHandoffErrors, GlobalBillingHandoffResponses, GlobalBillingProfileErrors, GlobalBillingProfileResponses, GlobalBillingStatusErrors, GlobalBillingStatusResponses, GlobalConfigGetResponses, GlobalConfigUpdateErrors, GlobalConfigUpdateResponses, GlobalDisposeResponses, GlobalEventResponses, GlobalHealthResponses, InstanceDisposeResponses, LspStatusResponses, McpAddErrors, McpAddResponses, McpAuthAuthenticateErrors, McpAuthAuthenticateResponses, McpAuthCallbackErrors, McpAuthCallbackResponses, McpAuthRemoveErrors, McpAuthRemoveResponses, McpAuthStartErrors, McpAuthStartResponses, McpConnectResponses, McpDisconnectResponses, McpLocalConfig, McpRemoteConfig, McpStatusResponses, OutputFormat, Part as Part2, PartDeleteErrors, PartDeleteResponses, PartUpdateErrors, PartUpdateResponses, PathGetResponses, PermissionListResponses, PermissionReplyErrors, PermissionReplyResponses, PermissionRespondErrors, PermissionRespondResponses, PermissionRuleset, PostQuestionE2eSeedResponses, ProjectCurrentResponses, ProjectListResponses, ProjectUpdateErrors, ProjectUpdateResponses, ProviderAuthResponses, ProviderListResponses, ProviderOauthAuthorizeErrors, ProviderOauthAuthorizeResponses, ProviderOauthCallbackErrors, ProviderOauthCallbackResponses, PtyConnectErrors, PtyConnectResponses, PtyCreateErrors, PtyCreateResponses, PtyGetErrors, PtyGetResponses, PtyListResponses, PtyRemoveErrors, PtyRemoveResponses, PtyUpdateErrors, PtyUpdateResponses, QuestionAnswer, QuestionInfo, QuestionListResponses, QuestionRejectErrors, QuestionRejectResponses, QuestionReplyErrors, QuestionReplyResponses, SessionAbortErrors, SessionAbortResponses, SessionChildrenErrors, SessionChildrenResponses, SessionCommandErrors, SessionCommandResponses, SessionCreateErrors, SessionCreateResponses, SessionDeleteErrors, SessionDeleteMessageErrors, SessionDeleteMessageResponses, SessionDeleteResponses, SessionDiffResponses, SessionForkResponses, SessionGetErrors, SessionGetResponses, SessionInitErrors, SessionInitResponses, SessionListResponses, SessionMessageErrors, SessionMessageResponses, SessionMessagesErrors, SessionMessagesResponses, SessionPromptAsyncErrors, SessionPromptAsyncResponses, SessionPromptErrors, SessionPromptResponses, SessionRevertErrors, SessionRevertResponses, SessionShareErrors, SessionShareResponses, SessionShellErrors, SessionShellResponses, SessionStatusErrors, SessionStatusResponses, SessionSummarizeErrors, SessionSummarizeResponses, SessionTaskEventsErrors, SessionTaskEventsResponses, SessionTaskGetErrors, SessionTaskGetResponses, SessionTaskListErrors, SessionTaskListResponses, SessionTaskResumeErrors, SessionTaskResumeResponses, SessionTodoErrors, SessionTodoResponses, SessionUnrevertErrors, SessionUnrevertResponses, SessionUnshareErrors, SessionUnshareResponses, SessionUpdateErrors, SessionUpdateResponses, SubtaskPartInput, TextPartInput, ToolIdsErrors, ToolIdsResponses, ToolListErrors, ToolListResponses, TuiAppendPromptErrors, TuiAppendPromptResponses, TuiClearPromptResponses, TuiControlNextResponses, TuiControlResponseResponses, TuiExecuteCommandErrors, TuiExecuteCommandResponses, TuiOpenHelpResponses, TuiOpenModelsResponses, TuiOpenSessionsResponses, TuiOpenThemesResponses, TuiPublishErrors, TuiPublishResponses, TuiSelectSessionErrors, TuiSelectSessionResponses, TuiShowToastResponses, TuiSubmitPromptResponses, VcsGetResponses, WorktreeCreateErrors, WorktreeCreateInput, WorktreeCreateResponses, WorktreeListResponses, WorktreeRemoveErrors, WorktreeRemoveInput, WorktreeRemoveResponses, WorktreeResetErrors, WorktreeResetInput, WorktreeResetResponses } from "./types.gen.js";
...
export declare class Billing extends HeyApiClient {
    /**
     * Get hosted billing status
     *
     * Proxy hosted billing status through the local sidecar server.
     */
    status<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<GlobalBillingStatusResponses, GlobalBillingStatusErrors, ThrowOnError, "fields">;
    /**
     * Get hosted billing profile
     *
     * Proxy hosted billing profile through the local sidecar server.
     */
    profile<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<GlobalBillingProfileResponses, GlobalBillingProfileErrors, ThrowOnError, "fields">;
    /**
     * Create hosted billing browser handoff
     *
     * Mint a short-lived hosted billing URL for opening m90.ai in a browser without exposing raw desktop tokens.
     */
    handoff<ThrowOnError extends boolean = false>(parameters?: {
        next?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<GlobalBillingHandoffResponses, GlobalBillingHandoffErrors, ThrowOnError, "fields">;
}
export declare class Config extends HeyApiClient {
    /**
     * Get global configuration
     *
     * Retrieve the current global M90 configuration settings and preferences.
     */
     ...
     *
     * Update global M90 configuration settings and preferences.
     */
...
export declare class Global extends HeyApiClient {
     ...
     * Get health
     *
     * Get health information about the M90 server.
     */
     ...
     * Get global events
     *
     * Subscribe to global events from the M90 system using server-sent events.
     */
     ...
     * Dispose instance
     *
     * Clean up and dispose all M90 instances, releasing all resources.
     */
...
export declare class Project extends HeyApiClient {
     ...
     * List all projects
     *
     * Get a list of projects that have been opened with M90.
     */
     ...
     * Get current project
     *
     * Retrieve the currently active project that M90 is working with.
     */
...
export declare class Pty extends HeyApiClient {
     ...
     * List PTY sessions
     *
     * Get a list of all active pseudo-terminal (PTY) sessions managed by M90.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class Config2 extends HeyApiClient {
     ...
     * Get configuration
     *
     * Retrieve the current M90 configuration settings and preferences.
     */
    get<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
     ...
     *
     * Update M90 configuration settings and preferences.
     */
    update<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        config?: Config3;
...
export declare class Runtime extends HeyApiClient {
    /**
     * Get local runtime environment
     *
     * Returns the allowlisted local runtime environment variables that saved Python scripts need in order to reach the hosted M90 proxy through the authenticated sidecar.
     */
    env<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalRuntimeEnvResponses, ExperimentalRuntimeEnvErrors, ThrowOnError, "fields">;
}
export declare class Session extends HeyApiClient {
    /**
     * List sessions
     *
     * Get a list of all M90 sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        roots?: boolean;
...
export declare class FlowOverlay extends HeyApiClient {
    /**
     * Transform content for flow overlay
     *
     * Display-only rewrite for consumer-friendly flow overlays.
     */
    transform<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        kind?: "chat" | "reasoning" | "tool" | "shell" | "code" | "diff";
        text?: string;
        preserveMarkdown?: boolean;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalFlowOverlayTransformResponses, unknown, ThrowOnError, "fields">;
}
export declare class Storage extends HeyApiClient {
    /**
     * Build storage manifest
     *
     * Returns a storage manifest combining stored media objects with local report context so the app can render a full storage explorer.
     */
    manifest<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalStorageManifestResponses, unknown, ThrowOnError, "fields">;
    /**
     * Upload storage assets
     *
     * Uploads one or more local files into storage, then stores library metadata so the desktop storage screen and agent can reference titled assets and groups.
     */
    ...
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalStorageUploadResponses, ExperimentalStorageUploadErrors, ThrowOnError, "fields">;
    /**
     * Upload storage assets (multipart)
     *
     * Uploads file bytes from the browser or clients without local path access. Same storage pipeline as JSON upload.
     */
    uploadMultipart<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalStorageUploadMultipartResponses, ExperimentalStorageUploadMultipartErrors, ThrowOnError, "fields">;
    /**
     * Update storage asset metadata
     *
     * Updates titles, descriptions, and group assignments for an uploaded storage asset.
     */
    asset<ThrowOnError extends boolean = false>(parameters?: {
        query_directory?: string;
        body_directory?: string;
        key?: string;
        title?: string;
        ...
        groupDescription?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalStorageAssetResponses, ExperimentalStorageAssetErrors, ThrowOnError, "fields">;
}
export declare class Lyria extends HeyApiClient {
    /**
     * Lyria music generation
     *
     * JSON proxy to the M90 worker tool `lyria_compose_music`, so platform actions can generate music through the same hosted path.
     */
    music<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        prompt?: string;
        style?: string;
    ...
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalLyriaMusicResponses, ExperimentalLyriaMusicErrors, ThrowOnError, "fields">;
}
export declare class Together extends HeyApiClient {
    /**
     * Together AI Whisper file transcription
     *
     * Multipart proxy to the M90 Cloudflare worker tool `together_transcribe`, so desktop and saved scripts use the same proxy-backed path.
     */
    transcription<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalTogetherTranscriptionResponses, ExperimentalTogetherTranscriptionErrors, ThrowOnError, "fields">;
}
export declare class Experimental extends HeyApiClient {
    /**
     * Proxy for Together AI Voice
     *
     * WebSocket proxy for Together AI realtime voice transcription.
     */
    voice<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ExperimentalVoiceResponses, unknown, ThrowOnError, "fields">;
    private _runtime?;
    get runtime(): Runtime;
    private _session?;
    get session(): Session;
    ...
    private _flowOverlay?;
    get flowOverlay(): FlowOverlay;
    private _storage?;
    get storage(): Storage;
    private _lyria?;
    get lyria(): Lyria;
...
export declare class Task extends HeyApiClient {
    /**
     * Resume session task
     *
     * Resume a durable session task from its last saved checkpoint.
     */
    resume<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        taskID: string;
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionTaskResumeResponses, SessionTaskResumeErrors, ThrowOnError, "fields">;
    /**
     * List session tasks
     *
     * List durable task summaries for a session.
     */
    list<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionTaskListResponses, SessionTaskListErrors, ThrowOnError, "fields">;
    /**
     * Get session task
     *
     * Get a durable task summary for a session task.
     */
    get<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        taskID: string;
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionTaskGetResponses, SessionTaskGetErrors, ThrowOnError, "fields">;
    /**
     * Get session task events
     *
     * Get parsed JSONL events for a durable session task.
     */
    events<ThrowOnError extends boolean = false>(parameters: {
        ...
        directory?: string;
        limit?: number;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionTaskEventsResponses, SessionTaskEventsErrors, ThrowOnError, "fields">;
}
export declare class Session2 extends HeyApiClient {
    /**
     * List sessions
     *
     * Get a list of all M90 sessions, sorted by most recently updated.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        roots?: boolean;
     ...
     * Create session
     *
     * Create a new M90 session for interacting with AI assistants and managing conversations.
     */
    create<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        parentID?: string;
     ...
     * Get session
     *
     * Retrieve detailed information about a specific M90 session.
     */
    get<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        directory?: string;
...
export declare class Instance extends HeyApiClient {
     ...
     * Dispose instance
     *
     * Clean up and dispose the current M90 instance, releasing all resources.
     */
...
export declare class Path extends HeyApiClient {
     ...
     * Get paths
     *
     * Retrieve the current working directory and related path information for the M90 instance.
     */
    get<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class Command extends HeyApiClient {
     ...
     * List commands
     *
     * Get a list of all available commands in the M90 system.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class App extends HeyApiClient {
     ...
     * List agents
     *
     * Get a list of all available AI agents in the M90 system.
     */
     ...
     * List skills
     *
     * Get a list of all available skills in the M90 system.
     */
...
export declare class M90Client extends HeyApiClient {
    static readonly __registry: HeyApiRegistry<M90Client>;
    constructor(args?: {
        client?: Client;
        key?: string;
    });
    postQuestionE2eSeed<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        sessionID?: string;
        questions?: Array<QuestionInfo>;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PostQuestionE2eSeedResponses, unknown, ThrowOnError, "fields">;
    private _auth?;
    get auth(): Auth;
    private _global?;
    get global(): Global;
