...
import type {
  ...
  ExperimentalLyriaMusicErrors,
  ExperimentalLyriaMusicResponses,
  ExperimentalResourceListResponses,
  ExperimentalRuntimeEnvErrors,
  ExperimentalRuntimeEnvResponses,
  ExperimentalSessionListResponses,
  ExperimentalStorageAssetErrors,
  ExperimentalStorageAssetResponses,
  ExperimentalStorageManifestResponses,
  ExperimentalStorageUploadErrors,
  ExperimentalStorageUploadMultipartErrors,
  ExperimentalStorageUploadMultipartResponses,
  ExperimentalStorageUploadResponses,
  ExperimentalTogetherTranscriptionErrors,
  ExperimentalTogetherTranscriptionResponses,
  ExperimentalVoiceResponses,
  FileListResponses,
  FilePartInput,
  FilePartSource,
  FileReadResponses,
  ...
  GlobalBillingHandoffErrors,
  GlobalBillingHandoffResponses,
  GlobalBillingProfileErrors,
  GlobalBillingProfileResponses,
  GlobalBillingStatusErrors,
  GlobalBillingStatusResponses,
  ...
  SessionTaskListErrors,
  SessionTaskListResponses,
  SessionTaskResumeErrors,
  SessionTaskResumeResponses,
  SessionTodoErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new M90Client()" to fix this error.`)
    }
    return instance
  }
...
export class Billing extends HeyApiClient {
  ...
  public status<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalBillingStatusResponses, GlobalBillingStatusErrors, ThrowOnError>({
  ...
  public profile<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<
      ...
      GlobalBillingProfileErrors,
      ThrowOnError
    >({ url: "/global/billing/profile", ...options })
  }
  ...
  public handoff<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "body", key: "next" }] }])
...
export class FlowOverlay extends HeyApiClient {
  /**
   * Transform content for flow overlay
   *
   * Display-only rewrite for consumer-friendly flow overlays.
   */
  public transform<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "kind" },
            { in: "body", key: "text" },
            { in: "body", key: "preserveMarkdown" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<ExperimentalFlowOverlayTransformResponses, unknown, ThrowOnError>({
...
export class Storage extends HeyApiClient {
  ...
  public manifest<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).get<ExperimentalStorageManifestResponses, unknown, ThrowOnError>({
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "groupId" },
            { in: "body", key: "groupTitle" },
            { in: "body", key: "groupDescription" },
            { in: "body", key: "files" },
          ],
        },
      ],
   ...
   */
  public uploadMultipart<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    },
    options?: Options<never, ThrowOnError>,
...
export class Lyria extends HeyApiClient {
  /**
   ...
   */
  public music<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      prompt?: string
      style?: string
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "prompt" },
            { in: "body", key: "style" },
            { in: "body", key: "composition_plan" },
            { in: "body", key: "model" },
            { in: "body", key: "model_id" },
            { in: "body", key: "backup_model" },
            { in: "body", key: "duration_seconds" },
            ...
            { in: "body", key: "reference_image_url" },
            { in: "body", key: "reference_image_data_url" },
          ],
        },
      ],
    )
...
export class Together extends HeyApiClient {
  /**
   ...
   */
  public transcription<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    },
    options?: Options<never, ThrowOnError>,
...
export class Experimental extends HeyApiClient {
  ...
  public voice<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).get<ExperimentalVoiceResponses, unknown, ThrowOnError>({
  ...
  private _flowOverlay?: FlowOverlay
  get flowOverlay(): FlowOverlay {
    return (this._flowOverlay ??= new FlowOverlay({ client: this.client }))
  }
  ...
  private _lyria?: Lyria
  get lyria(): Lyria {
    return (this._lyria ??= new Lyria({ client: this.client }))
  }

  private _together?: Together
  get together(): Together {
    return (this._together ??= new Together({ client: this.client }))
  }
}
...
export class Task extends HeyApiClient {
  ...
  public resume<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<SessionTaskResumeResponses, SessionTaskResumeErrors, ThrowOnError>({
  ...
  public list<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<SessionTaskListResponses, SessionTaskListErrors, ThrowOnError>({
...
export class M90Client extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<M90Client>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    M90Client.__registry.set(this, args?.key)
  }

  public postQuestionE2eSeed<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      sessionID?: string
    ...
    return (options?.client ?? this.client).post<PostQuestionE2eSeedResponses, unknown, ThrowOnError>({
